...
const Navbar = ({user1, likedTasks1}) => {
      ...
      <div className="container">
        ...
        <div className={`nav-elements  ${showNavbar && "active"}`}>
          <ul>
            ...
            <li>
              {user1 && <NavLink to="/todos">TodoApp</NavLink>}
            </li>
   
            <li>
              {user1 && likedTasks1 && <NavLink to="/likedtasks">LikedTasks</NavLink>}
            </li>
          
            <li className='login'>
              <NavLink to="/" >{!user1 ? 'Login' : 'Profile'}</NavLink>
            </li>
            <li className='login' style={!user1 ? {display: ''} : {display: 'none'}}>
              {!user1 && <NavLink to="/register">Register</NavLink>}
...
const Header = ({user, likedTasks}) => {
  return (
    <>
        <Navbar user1={user} likedTasks1={likedTasks}/>
